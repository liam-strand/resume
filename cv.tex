...
\begin{minipage}[t]{\linewidth}
    ...
    \begin{mylist}
        ...
        \item Manuscript Accepted at MTSR 2023: \href{https://www.eecs.tufts.edu/~lstran01/files/context-sensitive.pdf}{``Context-Sensitive Editing for the MEDFORD Metadata Language''} (\href{https://youtu.be/TFLdXxnaBlU}{Demo}) (\href{https://github.com/liam-strand/medford-language-server}{Repository})
    \end{mylist}
\end{minipage}
