...
\begin{minipage}[t]{\linewidth}
    ...
    \small \begin{mylist}
        ...
        \item Honorable Mention: Computing Research Association \textbf{Outstanding Undergraduate Researcher Award}
        \item \textbf{TUAA Senior Award} for outstanding leadership, significant academic achievement, and extraordinary service
    \end{mylist}
...
\begin{minipage}[t]{\linewidth}
    ...
    \begin{mylist}
        ...
        \item Led six-member multi-institutional team to deliver language support features, dramatically improved UX for end-users
        ...
        \item \todo{something about Fowler Family Summer Scholar grant sponsoring full-time work}
