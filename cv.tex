...
\begin{minipage}[t]{\linewidth}
    ...
    \small \begin{mylist}
        ...
        \item \textbf{David Krumme Award for Experimental Computer Science} for substantial projects of practical worth and meritorious research
        \item \textbf{Senior Award} for outstanding student leadership, academic achievement, and service
    \end{mylist}
...
\begin{minipage}[t]{\linewidth}
    ...
    \begin{mylist}
        ...
        \item Debugged complex Linux kernel driver compatibility issues by interfacing with hardware vendor engineers
    \end{mylist}
\end{minipage}

\begin{minipage}[t]{\linewidth}
    \textbf{Summer Scholar \textbar \ Bioinformatics and Computational Biology Group, Tufts University \textbar \ Medford, MA} \hfill \textbf{2022}
    \begin{mylist}
        ...
        \item Received Honorable Mention for CRA Outstanding Undergraduate Researcher award
        \item Led 6-member multi-institutional team to deliver language support features, improving UX for end-users
        ...
        \item Leveraged beta tester feedback and automated regression testing frameworks to ensure a polished and resliiant product
...
\begin{minipage}[t]{\linewidth}
    ...
    \begin{mylist} 
        \item Developed student work evaluation pipeline and organized guest lectures for concurrent and parallel programming courses
        \item Designed and led labs and review sessions for C and C++ machine structure and assembly language courses
        \item Taught performance analysis and debugging strategies using tools such as \texttt{gdb} and \texttt{valgrind}
        \item Collaborated with faculty to develop course infrastructure, assessments, and assignments, impacting $>$1000 students
    \end{mylist}
\end{minipage}

\begin{minipage}[t]{\linewidth}
    \textbf{Data Collection/Analysis \textbar \ Hither Creek Boatyard \textbar \ Madaket, MA} \hfill \textbf{2018 -- 2021}
    \begin{mylist}
...
\begin{minipage}[t]{\linewidth}
    ...
    \begin{mylist}
        \item Led 4 pp. team to develop audio mixing tool using Rust, Raspberry Pi microcontrollers, and directional bluetooth antennae
        \item Created flexible build system tooling to manage seamless cross-compilation and foreign library binding generation
        \item Developed hardware, firmware, and software solutions; managed scoping, planning, and delivery of all MVP targets
    \end{mylist}
\end{minipage}
