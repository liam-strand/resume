...
\begin{minipage}[t]{\linewidth}
    \textbf{Master of Science in Computer Science, Northwestern University, GPA: 3.95/4.00 } \hfill \textbf{2024 -- 2026}
    \begin{mylist}
        % \item Coursework: AI/ML in Robotics, Cloud Computing, CUDA, Distributed Systems, Networks, and Kernel Programming
        % \item Internet-Scale Experimentation, Constructing Compilers
        \item Coursework: Compilers, CUDA, Distributed Systems, Internet-Scale Experimentation, and Kernel Programming
        \item Spring 2026: Parallel Architectures
        \item Thesis in progress: \textit{Adaptive Profiling via ML-Driven Hardware Counter Orchestration}
    \end{mylist}
    \vspace{0.5em}
...
\section{Experience}
% \begin{minipage}[t]{\linewidth}
%     \textbf{Apple Silicon GPU Driver Engineer \textbar \ Apple \textbar \ Cupertino, CA} \hfill \textbf{Aug 2026 -- Present} 
% \end{minipage}
...
\begin{minipage}[t]{\linewidth}
    ...
    \begin{mylist}
        ...
        \item Approved all changes to the Rust codebase, conducted code reviews, and mentored interns on parallel projects
    \end{mylist}
\end{minipage}
...
\begin{minipage}[t]{\linewidth}
    \textbf{Hither Creek Boatyard \textbar \ Data Collection/Analysis \textbar \ Madaket, MA} \hfill \textbf{Summer/Winter 2018 -- 2021}
    \begin{mylist}
