...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
    \textbf{Concurrent Simulations:} \href{https://github.com/liam-strand/cs-21-final-project}{\textbf{on-the-road-again}} and \href{https://github.com/liam-strand/cs121-p5}{\textbf{MetroSim}} & \hfill 2022 \\[3.75pt]
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
    \href{https://github.com/liam-strand/cs121-p3}{\textbf{Java Testing Framework}} & \hfill 2022 \\[3.75pt]
...
%-------------------------------------------------------------------------------
\section{Skills}
\normalsize{Agile, Bash, C, C++, Concurrent/Parallel Programming, Docker, Erlang, \texttt{git}, GitHub, GitLab, Java, Jira, Linux/Unix, Profiling, Python, Rust, Swift, \texttt{gdb}, \LaTeX}
