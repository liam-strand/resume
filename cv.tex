...
\begin{minipage}[t]{\linewidth}
    \textbf{Master of Science in Computer Science, Northwestern University, GPA: 3.94/4.00 } \hfill \textbf{2024 -- 2026}
    \begin{mylist}
        \item Coursework: AI/ML in Robotics, Cloud Computing, CUDA, Distributed Systems, Networks, and Kernel Programming
        \item Spring 2026: Internet-Scale Experimentation, Constructing Compilers
