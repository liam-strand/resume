...
\begin{minipage}[t]{\linewidth}
    ...
    \small Data Structures/Algorithms, Machine Structure and Assembly Language Programming, Software Engineering, Concurrent Programming, \qquad Parallel Computing, Computational Theory, Programming Languages, Cybersecurity. Fall 2023: Machine Learning, Spatial Audio Software. \qquad \qquad \qquad \qquad Spring 2024: Operating Systems, Quantum Computing, Computer Engineering. (\textbf{Dean's List 6/6 semesters})
